...
object_key = '1SorNemSorCpp.png'
# ************* REQUEST VALUES ScaleWay *************
method = 'GET'
service = 's3'
host = 'laboschqpa.s3.pl-waw.scw.cloud'
region = 'pl-waw'
endpoint = 'https://laboschqpa.s3.pl-waw.scw.cloud/' + object_key
access_key = appSecrets.secretAccessKeys.get('scaleWay').get('id')
secret_key = appSecrets.secretAccessKeys.get('scaleWay').get('secret')
